...
jigSaw = {
  ...
  callAPI: function() {
    if (ditto == false) {
      ...
      xhttp.open("GET", "https://github.com/mwissig/pokegym/blob/master/limber/132", true);
      xhttp.send();
      ditto = true;
      ...
      xhttp.open("GET", "https://github.com/mwissig/pokegym/blob/master/458/Mantyke", true);
      xhttp.send();
      mantyke = true;
      ...
      xhttp.open("GET", "https://github.com/mwissig/pokegym/blob/master/770/ghost", true);
      xhttp.send();
      palossand = true;
    } else {
